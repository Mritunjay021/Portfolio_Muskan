        ...
        <div id='about' className='homepage_container'>
            ...
            className='homepage_left'>
                ...
                <div>
                    ...
                    <a href='https://x.com/muskan_ahuja' target='_blank'>
                        <img 
                            src={twitterIcon} 
                            alt="twitterIcon" 
                            className='homepage_icons'
                    ...
                    <a href='https://www.linkedin.com/in/muskanahuja30/' target='_blank'>
                        <img 
                            src={linkedinIcon} 
                            alt="linkedinIcon" 
                            className='homepage_icons'
                ...
                <a href="mailto:muskanahuja167@gmail.com">
